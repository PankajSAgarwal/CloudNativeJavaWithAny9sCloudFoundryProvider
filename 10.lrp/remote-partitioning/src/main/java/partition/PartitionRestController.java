...
public class PartitionRestController {
    ...
    ResponseEntity<?> status(){
        ...
        status.put("people.count",
                this.jdbcOperations.queryForObject("select count(*) from PEOPLE ",
                        Number.class));

        status.put("new_people.count",
                this.jdbcOperations.queryForObject("select count(*) from NEW_PEOPLE", Number.class));
