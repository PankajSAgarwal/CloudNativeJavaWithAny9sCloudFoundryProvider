...
import static demo.TestUtils.lambdaMatcher;
...
public class CustomerRestControllerTest {
    ...
    public void testGetCollection() throws Exception{
        List<Customer> customers
                = Arrays.asList(this.wellKnownCustomer,
        ...
        this.mockMvc
                ...
                .andExpect(jsonPath("$",hasSize(lambdaMatcher("the count should be >= 1", (Integer i) -> i >= 1))));
    }
    ...
    public void testPost() throws Exception {
        ...
        Customer savedCustomer = new Customer(2L, customer.getFirstName(),customer.getLastName());
    ...
    public void testDelete() throws Exception {
        this.mockMvc
                .perform(
                        delete(this.rootPath +"/" + this.wellKnownCustomer.getId()).contentType(this.jsonContentType)
                )
    ...
    public void testHead() throws Exception {
        ...
        this.mockMvc.perform(
                head(this.rootPath + "/" + this.wellKnownCustomer.getId())
